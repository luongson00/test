...
//        "AND dbo.HoaDon.TTThanhtoan = 0 AND Donchinh = 1 AND dbo.HoaDon.ID_Hoadon = ?";
    ...
    public void insert(Ban Entity) {
        Helper.JDBCHelper.update(INSERT_SQL, Entity.getIdBan(), Entity.isTrangThai(),Entity.isHoatDong(),Entity.getSoluongcho());
    }

    @Override
    public void updateTrangThai(int id) {
        Helper.JDBCHelper.update(UPDATE_SQL_TRANGTHAI, id);
    }

    @Override
    public void deleteTRangThai(int id) {
        Helper.JDBCHelper.update(DELETE_SQL_TRANGTHAI, id);
    }
...
//    }
    ...
    public void updateHoatDong(int id) {
        Helper.JDBCHelper.update(UPDATE_SQL_HD, id);
    }

    @Override
    public void deleteHoatDong(int id) {
        Helper.JDBCHelper.update(DELETE_SQL_HD, id);
    }
    ...
    public void delete(int id) {
        Helper.JDBCHelper.update(DELETE, id);
    }
    ...
    public void update(Ban Entity) {
        Helper.JDBCHelper.update(UPDATE_SQL, Entity.getSoluongcho(), Entity.isTrangThai(), Entity.isHoatDong(), Entity.getIdBan());
    }
