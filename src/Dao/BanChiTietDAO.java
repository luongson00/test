...
public class BanChiTietDAO implements InterfaceBanchitiet{
    ...
    public void insert(BanChiTiet Entity) {
        Helper.JDBCHelper.update(INSERT_SQL, Entity.getID_Ban(), Entity.getID_HoaDon(), Entity.getThoidiemCoNguoi(), Entity.isBanChinh());
    }

    @Override
    public void update(int idban,int idHoadon) {
        Helper.JDBCHelper.update(UPDATE_SQL, idban,idHoadon);
    }

    @Override
    public void delete(int id) {
        Helper.JDBCHelper.update(DELETE_SQL, id);
    }
