...
public class PrintThongKe {
    ...
    public void xuatpdf_ngay(DefaultTableModel model,DefaultTableModel model1){
        ...
        try {
            File newFile = new File("C:\\Users\\sonlu\\OneDrive\\Desktop\\DuAn1-QuanLyUpCofffee\\printthongke\\baocaongay.pdf");
            PdfWriter.getInstance(document, new FileOutputStream(newFile.getAbsoluteFile().getPath()));
            document.open();
            Font f = new Font(BaseFont.createFont("C:\\Users\\sonlu\\OneDrive\\Desktop\\DuAn1-QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f.setSize(16);
            Font f2 = new Font(BaseFont.createFont("C:\\Users\\sonlu\\OneDrive\\Desktop\\DuAn1-QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f2.setSize(12);
            Font f3 = new Font(BaseFont.createFont("C:\\Users\\sonlu\\OneDrive\\Desktop\\DuAn1-QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f3.setSize(10);
           
             Font f4 = new Font(BaseFont.createFont("C:\\Users\\sonlu\\OneDrive\\Desktop\\DuAn1-QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f4.setSize(14);
